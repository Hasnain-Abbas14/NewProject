            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Helper()
                        .customText("Foods", 25, FontWeight.bold, Colors.black),
                    Card(
                        shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(12)),
                        child: IconButton(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Helper().customText(
                        "Add Word", 16, FontWeight.bold, Colors.black),
                    Helper().customText(
                        "Start Quiz", 16, FontWeight.bold, Colors.black),
                  ],
                ),
              ),
          ...
          child: Column(
                ...
                Card(
                  ...
                  Padding(
                    ...
                    child: Helper().customButton(page10(), "Save Word", Colors.white, Colors.black, 12),
                  ),
                ],
              ),
        );
